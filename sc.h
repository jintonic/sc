...
#define ERR_ (OP_BASE + 59)
#define PI_ (OP_BASE + 60)
#define BLACK (OP_BASE + 61)
#define RED (OP_BASE + 62)
#define GREEN (OP_BASE + 63)
#define YELLOW (OP_BASE + 64)
#define BLUE (OP_BASE + 65)
#define MAGENTA (OP_BASE + 66)
#define CYAN (OP_BASE + 67)
#define WHITE (OP_BASE + 68)
...
extern	int savedrow[27], savedcol[27];
extern	int savedstrow[27], savedstcol[27];
...
extern	void copy(struct ent *dv1, struct ent *dv2, struct ent *v1,
	struct ent *v2);
extern	void copyent(register struct ent *n, register struct ent *p, int dr,
	int dc);
